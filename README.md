...
[![Evals](https://img.shields.io/badge/Evals-5%2F5%20passing-brightgreen?style=flat-square)]()
...
```
You: https://www.linkedin.com/jobs/view/...
...
```
Current baseline: 5/5 passed (100%)  |  threshold: 80%
...
├── servers/
│   ├── search_server.py       # scrapes jobs, extracts skills (HTTP, Railway)
